...
function menu_close() {
    let iconMenu = document.querySelector(".menu-toggle");
...
// const counters = document.querySelectorAll('.skills-info__number'),
//       lines = document.querySelectorAll('.skills-info__bottom span');
